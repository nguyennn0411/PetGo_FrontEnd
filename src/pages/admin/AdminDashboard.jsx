...
const AdminDashboard = () => {
  return (
    <AdminLayout title="Dashboard admin">
      ...
      <div className="card mb-0"><div className="card-title">Dashboard production</div><p className="text-muted mt-8">Đã gỡ số liệu demo. Cần nối API thống kê admin thật trước khi hiển thị KPI, biểu đồ và booking gần đây.</p></div>
    </AdminLayout>
  );
};
