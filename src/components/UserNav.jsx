            ...
            {open && (
                <div className="border-t border-gray-100 bg-white px-4 py-4 pb-28 lg:hidden">
                    <div className="grid gap-2 max-h-[calc(100vh-5rem)] overflow-y-auto pr-1">
                        ...
                        {account && (
                            <Link to="/notifications" onClick={() => setOpen(false)} className="flex items-center gap-3 rounded-2xl px-4 py-3 text-sm font-black text-gray-900 hover:bg-orange-50">
